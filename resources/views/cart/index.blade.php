            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="mt-6 flex justify-between items-center border-t pt-6">
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('menu.index') }}" class="px-6 py-3 border rounded-full hover:bg-gray-100">Lanjut
                            Belanja</a>
                        <a href="{{ route('checkout.index') }}"
                            class="bg-black text-white px-8 py-3 rounded-full font-bold hover:bg-gray-800 text-center">
                            Checkout Sekarang
                        </a>
                    </div>
                </div>
        ...
        @else
            <div class="text-center py-20">
                ...
                <a href="{{ route('menu.index') }}"
                    class="mt-4 inline-block bg-black text-white px-6 py-3 rounded-full">Mulai Pesan</a>
            </div>
        @endif
    </div>
@endsection
